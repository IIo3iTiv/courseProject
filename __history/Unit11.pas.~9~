...
procedure TForm11.Label14Click(Sender: TObject);
begin
  if Not(newRecord) then
  begin
    setViewMode;
...
procedure TForm11.Label15Click(Sender: TObject);
begin
  if Not(newRecord) then
  begin
    setViewMode;
...
procedure TForm11.Label17Click(Sender: TObject);
begin
  if Not(newRecord) then
  begin
    setViewMode;
...
procedure TForm11.Label41Click(Sender: TObject);
begin
  if Not(newRecord) then
  begin
    setViewMode;
...
procedure TForm11.Label45Click(Sender: TObject);
var btn: integer;
begin
  if Not(newRecord) then
  begin
