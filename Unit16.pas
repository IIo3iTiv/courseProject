...
procedure TForm16.Label3MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  Label3.Font.Color := RGB(210, 16, 77);
end;

procedure TForm16.Label3MouseLeave(Sender: TObject);
begin
  Label3.Font.Color := clCream;
end;

procedure TForm16.Label3MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
