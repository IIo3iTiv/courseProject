...
begin
  ...
  Form1.ComboBox2.Color := RGB(26, 20, 59);
  Form1.Shape4.Pen.Color := RGB(13, 156, 50);
  Form1.Label37.Font.Color := RGB(13, 156, 50);
...
procedure TForm1.Label37MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  Form1.Label37.Font.Color := RGB(230, 230, 230);
  Form1.Shape4.Pen.Color := RGB(210, 16, 77);
end;

procedure TForm1.Label37MouseLeave(Sender: TObject);
begin
  Form1.Label37.Font.Color := RGB(13, 156, 50);
  Form1.Shape4.Pen.Color := RGB(13, 156, 50);
end;
...
procedure TForm1.Label37MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  Form1.Label37.Font.Color := clCream;
  Form1.Shape4.Pen.Color := RGB(248, 16, 77);
end;
